...
class AppConfig {
  //configure this
  static String copyright_text = '\u00a9 ${this_year} ODIQCO All rights reserved'; //this shows in the splash screen
  // static String copyright_text = "@ ActiveItZone " + this_year; //this shows in the splash screen
  static String app_name = "ODIQCO"; //this shows in the splash screen
  static String search_bar_text = "Search Product..."; //this will show in app Search bar.
